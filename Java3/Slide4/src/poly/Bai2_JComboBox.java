 ...
 * @author ADMIN
 */
public class Bai2_JComboBox extends javax.swing.JFrame {

    /**
     * Creates new form Bai2_JComboBox
     */
    public Bai2_JComboBox() {
        initComponents();
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        cbbMonHoc.addItem(txtMonHocYT.getText());
    }//GEN-LAST:event_btnAddActionPerformed

    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed


        cbbMonHoc.removeItem(txtMonHocYT.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bai2_JComboBox.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Bai2_JComboBox().setVisible(true);
            }
        });
    }
