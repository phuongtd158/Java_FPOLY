...
<div class="container">
    <div class="row">
        <div class="col-md-5">
            ...
            <form action="/Lab3/bai2" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-7">
            <ul>
                <li>
                    ...
                    <img src="upload/${user.image}" alt="" style="width: 100px; height: 100px"
                </li>
                <li>${user.username}</li>
                <li>>${user.password}</li>
                <li>>${user.gender == true ? "Nam" : "Nữ"}</li>
                <li>>${user.married == null ? "Chưa lập gia đình" : "Đã lập gia đình"}</li>
                <li>>${user.country}</li>
                <li>>${user.hobbies}</li>
                <li>>${user.notes}</li>
            </ul>
